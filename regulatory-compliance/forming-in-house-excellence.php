...
<head>
    ...
    <title>Forming In-House Excellence</title>
...
<body> 
    ...
    <!--Header Wrapper-->
    <div class="inner-header subpage" style="background: #000 url('assets/images/banners/empowering-aml-compliance-header-bg.webp') no-repeat center center / cover;">
        <div class="container">
            <p class="h1 text-start">Forming In-House Excellence</p>
            <ul class="text-white check__list ps-0">
                <li>
                    Leaders of In-House AML Compliance Formation  
                </li>
                <li> 
                    Committed to Enduring Client Partnerships
                </li>
                <li> 
                    Expert Guidance for Regulatory Frameworks
                </li> 
            </ul> 
            <div class="mt-4"> 
    ...
    <section class="pb-5">
        <div class="container"> 
            <h1 class="h2 h2color pt-2 text-center">Empowering AML Compliance: Forming In-House Excellence</h1>
            ...
            <h2 class="mt-5 pt-md-4 mb-3 mb-md-4 h2 h2color">What Constitutes an AML Compliance Department?</h2>
            <p>
            ...
            <h2 class="mt-5 pt-md-4 mb-3 mb-md-4 h2 h2color">Setting Up an In-House AML Compliance Department in the UAE: Our Methodology</h2>
            <p>
            ...
            <h3 class="mt-5 pt-md-4 mb-3 h2 h2color">The key steps of our approach encompass:</h3> 

            <h4 class="mt-5 mb-3 h3 h2color">Analyzing Business AML Requirements</h4>
            <p>
            ...
            <h4 class="mt-5 mb-3 h3 h2color">Establishing Rules and Responsibilities</h4>
            <p>
            ...
            <h4 class="mt-5 mb-3 h3 h2color">Assignment of an AML Compliance Officer</h4>
            <p>
            ...
            <h4 class="mt-5 mb-3 h3 h2color">Establishment of In-House AML Compliance Department</h4>
            <p>
