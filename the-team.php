...
<head>
    ...
    <title>The Team Behind The International Law Firm in Dubai | Fotis</title>
    <link rel="canonical" href="<?php echo $base_url;?>the-team.php" />
 ...
 <body> 
    ...
    <div class="inner-header mb-0" style="background-image:url('assets/images/about/team-page-header-bg-image.webp');box-shadow: inset 0 0 0 2000px rgba(0, 0, 0, 0.5);">
        <div class="container z-index"> 
            <h1 class="text-center h1">Our Team</h1>
        </div> 
    </div>
    <!-- Header Wrapper Start -->

    <!-- Header Bottom Start -->
    <?php // require ('_header-bottom.inc.php'); ?>
    <!-- Header Bottom End -->

    <!-- About us start -->
    <section class="" style="background: url('assets/images/about/top_lawyers_uae.webp') no-repeat center center / cover;">
        <div class="container">
            <div class="row g-0 justify-content-end"> 
                <div class="col-lg-8 col-xl-6 py-5 ps-lg-5 after__bg">
                    <div style="position: relative;z-index: 99;"> 
                        <div class="text-center mb-4 d-lg-none"> 
                            <img src="assets/images/about/top_lawyers_uae.webp" width="518" height="206" class="img-fluid" alt="who we are">
                        </div> 
                        <h2 class="h2 text-colored text-uppercase">Top Lawyers in UAE</h2>
                        <p class="text-white mt-3 mt-lg-4">
                            Fotis provides comprehensive legal solutions for your complicated corporate affairs.Our aim is to
                            provide strategic legal advice based on the client’s industry and requirements. We understand
                            that there is a fine line between being legally efficient and commercially effective. Therefore,
                            our lawyers in Sharjah and UAE aim to provide top best legal advice to our clients in the region
                            in order to safeguard their business interests and maintain long standing corporate
                            relationships.
                        </p>
                        <p class="text-white">
                            Our law firm in UAE handles various matters from corporate restructuring to drafting technical
                            contractual agreements and commercial matters such as debt recovery to trade mark registration.
                            Our mission is to provide commercially viable and legally efficient advice that would help you
                            me…
                        </p>
                    </div>
                </div>
    ...
    <section class="inner-header1 h-auto py-5 d-flex align-items-center position-relative" style="background-image:url('assets/images/about/Fraud-Criminal-Law-in-UAE.jpg');background-attachment: fixed; background-position: bottom center;background-repeat: no-repeat;  background-size: cover;">
        <div class="position-absolute top-0 start-0 w-100 h-100 user-select-none z-0" style="background: rgba(0,0,0,.5);"></div>
        <div class="container text-center position-relative z-1 w-100 py-4 py-lg-5">
            <div class="row g-4">
                <div class="col-md-3 text-center">
                    <img src="assets/images/about/about-i1.png" width="125" height="125" class="img-fluid team__short__info__icon" alt="icon" />
                    <h4 class="text-white mt-3 mt-lg-4">Dedicated Practice</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="assets/images/about/about-i2.png" width="125" height="125" class="img-fluid team__short__info__icon" alt="icon" />
                    <h4 class="text-white mt-3 mt-lg-4">Seasoned Attorneys</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="assets/images/about/about-i3.png" width="125" height="125" class="img-fluid team__short__info__icon" alt="icon" />
                    <h4 class="text-white mt-3 mt-lg-4">Global Network</h4>
                </div>
                <div class="col-md-3 text-center">
                    <img src="assets/images/about/about-i4.png" width="125" height="125" class="img-fluid team__short__info__icon" alt="icon" />
                    <h4 class="text-white mt-3 mt-lg-4">Client-oriented Approach</h4>
                </div>
            </div>
        </div> 
    </section>
    ...
    <div class="pt-5 pb-3">
        <div class="container">
            <p class="mt-1">Our corporate lawyers in Dubai are renowned for their expertise in their particular
                field or area of practice. Each office comprises dedicated teams of lawyers that specialize in a
                practice area and industry/ sector. We ensure that the quality of work that we provide is not hurt
                by ensuring that every matter is overlooked by a partner at the firm. This helps us to ensure that
                each case is dealt with in the most efficient and effective manner. Our expert lawyers in Sharjah
                have gained the trust of numerous clients after servicing them to the best of their abilities and
                legal integrity.</p> 
        </div>
    </div>
