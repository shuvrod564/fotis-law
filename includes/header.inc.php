    ...
    <nav class="navbar sticky-top navbar-expand-lg mt-1">
        <div class="container position-relative">
            <a class="navbar-brand" href="<?php echo $base_url;?>" aria-label="Fotis Law Logo"><img src="<?php echo $base_url;?>assets/images/logo.svg" width="105" height="46" class="w-auto" alt="Fotis Law" /></a>
    
            <button class="navbar-toggler navbar-light" type="button" data-bs-toggle="collapse" data-bs-target="#MainNav" aria-controls="MainNav" aria-expanded="false" aria-label="Toggle navigation">
                <svg xmlns="http://www.w3.org/2000/svg" height="28" width="26" viewBox="0 0 448 512"><path fill="#fff" d="M0 96C0 78.3 14.3 64 32 64H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32C14.3 128 0 113.7 0 96zM0 256c0-17.7 14.3-32 32-32H416c17.7 0 32 14.3 32 32s-14.3 32-32 32H32c-17.7 0-32-14.3-32-32zM448 416c0 17.7-14.3 32-32 32H32c-17.7 0-32-14.3-32-32s14.3-32 32-32H416c17.7 0 32 14.3 32 32z"/></svg>
            </button>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-sm-0 ">
                    ...
                    <li class="nav-item dropdown has-megamenu">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown"
                            aria-expanded="false">Practice Areas <i class="sub-arrow"></i></a>
                    ...
                    <li class="nav-item dropdown has-megamenu">
                        <a class="nav-link dropdown-toggle" href="#" id="dropdown02" data-bs-toggle="dropdown"
                            aria-expanded="false">Sectors <i class="sub-arrow"></i></a>
                        <div class="dropdown-menu megamenu" role="menu">
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="col-megamenu">
                    ...
                    <li class="nav-item ms-lg-4">
                        <a class="nav-link btn-primary" href="<?php echo $base_url;?>contact-us.php">Submit Enquiry</a>
                    </li>
                </ul>
            </div>
        </div>
